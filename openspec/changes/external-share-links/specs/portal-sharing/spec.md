...
**Reason:** Ersetzt durch externe Freigabe-Links; User-zu-User-Sharing entfällt (Empfänger haben keinen Portal-Account mehr).

### Requirement: Mit mir geteilte Dokumente einsehen
**Reason:** „Geteilt mit mir" entfällt — Nicht-Admins haben keinen Portal-Zugang; Empfang läuft über externe Links.

### Requirement: Freigaben eines Dokuments einsehen
**Reason:** Ersetzt durch Verwaltung externer Freigabe-Links (siehe ADDED).

### Requirement: Freigabe widerrufen
**Reason:** Ersetzt durch Widerruf externer Freigabe-Links (siehe ADDED).

### Requirement: Zugriff auf ein freigegebenes Dokument
**Reason:** Ersetzt durch login-freien Zugriff über Token-Link (siehe ADDED).
