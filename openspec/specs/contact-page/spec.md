...
Eine eigenständige Kontaktseite unter der Route `/kontakt`, die das bestehende
Kontaktformular als vollwertige Seite darstellt und aus beliebigen Inhalten per
interner Navigation (z. B. CMS-CTA-Buttons) erreichbar ist. Die Seite nutzt das
Standard-Seitenlayout (Navbar/Footer) und teilt sich die Formular-Logik mit der
Kontakt-Sektion der Landing-Page, ohne diese zu verändern.
