...
export const OfferingList = () => {
  ...
  const fetchPosts = async () => {
    try {
      const res = await authFetch('/api/admin/pages?category=OFFERING');
      if (res.ok) {
  ...
  return (
    <div className="admin-list-page">
      <div className="list-header">
        <h1><i className="bi bi-briefcase"></i> Leistungen-Verwaltung</h1>
        <button className="btn-primary" onClick={() => navigate('/admin/cms/offerings/new')}>
              ...
              posts.map(post => (
                <tr key={post.id}>
                  ...
                  <td className="actions">
                    <button className="btn-sm" onClick={() => navigate(`/admin/cms/offerings/${post.id}`)}>
