...
public class AdminContentController {
    ...
    @PutMapping("/{key}")
    public ResponseEntity<ContentBlockDto> saveDraft(@PathVariable String key, @RequestBody String contentJson) {
    ...
    public AdminContentController(final ContentService contentService) {
