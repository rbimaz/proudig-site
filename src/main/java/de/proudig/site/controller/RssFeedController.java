...
public class RssFeedController {
    ...
    public ResponseEntity<String> getBlogFeed() {
        try {
            ...
            var blogPosts = pageRepository.findByCategoryAndStatus(PageCategory.BLOG, PageStatus.PUBLISHED, pageable);
            String rssContent = generateRssFeed(blogPosts.getContent(), "ProuDig Blog", "https://proudig.de/blog", "Latest blog posts from ProuDig");
    ...
    public RssFeedController(final PageRepository pageRepository) {
