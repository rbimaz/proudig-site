...
public class SeminarController {
    ...
    @GetMapping
    public ResponseEntity<Page<PageDto>> getUpcomingSeminars(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
    ...
    @GetMapping("/archiv")
    public ResponseEntity<Page<PageDto>> getArchivedSeminars(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
    ...
    public SeminarController(final PageService pageService) {
