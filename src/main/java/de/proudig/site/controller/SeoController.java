...
public class SeoController {
    ...
    private SeoMetaDto buildSeoMeta(Page page, String canonicalUrl) {
        ...
        return SeoMetaDto.builder()
                .title(page.getTitle())
                .description(page.getExcerpt() != null ? page.getExcerpt() : page.getTitle())
                .ogTitle(page.getTitle())
                .ogDescription(page.getExcerpt() != null ? page.getExcerpt() : page.getTitle())
                .ogImage(coverImageUrl)
                .ogType(page.getCategory() == PageCategory.BLOG ? "article" : "website")
